      ...
      <div id="smooth-content">
        <main class="main">
          ...
          <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.jpg)">
            <div class="container">
              <h3 class="breadcrumb-title">Service Two</h3>
          ...
          <!-- service-area -->
          <div class="service-area sa-2 py-120">
            <div class="container">
              <div class="container">
                <div class="row">
                  <div class="col-lg-7 mx-auto">
                    <div class="site-heading text-center">
                      <span class="site-title-tagline wow fadeInUp"><i class="far fa-gear"></i> Our Services</span>
                      <h3 class="site-title ani-text-1">High volume production & industrial services</h3>
                    </div>
                  </div>
                </div>
                <div class="row g-4">
                  <div class="col-md-6 col-lg-3">
                    <div class="service-item wow fadeInUp" data-wow-delay=".2s">
                      ...
                      <div class="service-icon">
                        <img src="assets/img/icon/conveyor-belt-arm.svg" alt="" />
                      </div>
                      <div class="service-content">
                        <h4><a href="service-single.html">Automation Integrate</a></h4>
                        <p>It is long establish fact that read will distract content layout.</p>
                        <div class="service-bottom">
                          <a href="service-single.html" class="service-link">Learn More<i class="fas fa-arrow-right"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-3">
                    <div class="service-item wow fadeInUp" data-wow-delay=".4s">
                      ...
                      <div class="service-icon">
                        <img src="assets/img/icon/machinery.svg" alt="" />
                      </div>
                      <div class="service-content">
                        <h4><a href="service-single.html">Machinery Fabrication</a></h4>
                        <p>It is long establish fact that read will distract content layout.</p>
                        <div class="service-bottom">
                          <a href="service-single.html" class="service-link">Learn More<i class="fas fa-arrow-right"></i></a>
                        </div>
                  ...
                  <div class="col-md-6 col-lg-3">
                    <div class="service-item wow fadeInUp" data-wow-delay=".6s">
                      ...
                      <div class="service-icon">
                        <img src="assets/img/icon/manufacture.svg" alt="" />
                      </div>
                      <div class="service-content">
                        <h4><a href="service-single.html">Industry Manufacture</a></h4>
                        <p>It is long establish fact that read will distract content layout.</p>
                        <div class="service-bottom">
                          <a href="service-single.html" class="service-link">Learn More<i class="fas fa-arrow-right"></i></a>
                        </div>
                  ...
                  <div class="col-md-6 col-lg-3">
                    <div class="service-item wow fadeInUp" data-wow-delay=".8s">
                      <span class="count">04.</span>
                      <div class="service-icon">
                        <img src="assets/img/icon/workflow-setting.svg" alt="" />
                      </div>
                      <div class="service-content">
                        <h4><a href="service-single.html">Equipment Install</a></h4>
                        <p>It is long establish fact that read will distract content layout.</p>
                        <div class="service-bottom">
                          <a href="service-single.html" class="service-link">Learn More<i class="fas fa-arrow-right"></i></a>
                        </div>
